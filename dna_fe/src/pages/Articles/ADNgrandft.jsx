...
const ADNgrandparent = () => {
  return (
    <div className="guide-container">
      <h1 className="guide-title">Xét nghiệm ADN ông bà cháu – Những điều quan trọng cần biết</h1>

      <section className="guide-section">
        <h2 className="section-title">1. Xét nghiệm ADN ông bà cháu được không?</h2>
        <p>
          Xác định mối quan hệ huyết thống giữa ông bà (nội hoặc ngoại) và cháu hoàn toàn có thể thực hiện dựa 
          trên phương pháp giám định ADN.
        </p>
        <p>
          Xét nghiệm ADN ông bà cháu được thực hiện khi không có mẫu người cha hoặc mẹ (do cha mẹ vắng mặt vì 
          lý do khách quan hoặc không muốn tham gia xét nghiệm).
        </p>
        <p>
          Dựa trên quy luật di truyền học, xét nghiệm ADN ông bà cháu phải tính các đặc điểm di truyền trên nhiễm 
          sắc thể (NST) Y, NST X hoặc ADN ti thể để xác định mối quan hệ huyết thống. Cụ thể:
        </p>
        <ul>
          <li>Phân tích NST Y (Y-STR) áp dụng cho trường hợp ông nội và cháu trai để xác định di truyền tương đồng di 
          truyền trong dòng họ nội.</li>
          <li>Phân tích NST X áp dụng cho các trường hợp ông bà nội/ngoại với cháu gái, dựa trên nguồn gốc di 
          truyền từ cha hoặc mẹ.</li>
          <li>Phân tích ADN ti thể được sử dụng để xác định quan hệ qua dòng mẹ giữa bà ngoại và cháu (cả trai và 
          gái), do ADN ti thể truyền từ mẹ sang con qua nhiều thế hệ.</li>
        </ul>
        <p>
          Bằng cách kết hợp các phương pháp trên, xét nghiệm ADN ông bà cháu có thể đưa ra kết luận chính xác về 
          mối quan hệ huyết thống mà không cần chia mẫu thành các loại riêng biệt.
        </p>
      </section>

      <section className="guide-section">
        <h2 className="section-title">2. Xét nghiệm ADN ông bà cháu có chính xác không?</h2>
        <p>
          Xét nghiệm ADN là phương pháp xác định quan hệ huyết thống có độ chính xác cao nhất hiện tại.
        </p>
        <p>
          Dựa theo quy luật di truyền, xét nghiệm ADN ông – cháu, bà – cháu là phân tích và so sánh các gen trên NST giới 
          tính X và Y hoặc ADN ti thể, độ chính xác của các xét nghiệm này lên đến 99,9998%.
        </p>
      </section>

      <section className="guide-section">
        <h2 className="section-title">3. Làm thế nào để xét nghiệm ADN ông bà cháu?</h2>
        <p>Tùy thuộc vào mục đích xét nghiệm mà loại mẫu, thủ tục và quy trình công sẽ đòi hỏi khác nhau:</p>
